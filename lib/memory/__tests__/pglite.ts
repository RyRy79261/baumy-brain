...
CREATE TABLE baumy_house_config (id boolean PRIMARY KEY DEFAULT true, house_group_chat_id text, live_chat_id text, migrated_from_chat_id text, reminder_thread_id bigint, house_timezone text NOT NULL DEFAULT 'Europe/Berlin', response_policy jsonb NOT NULL DEFAULT '{"global_enabled":true,"categories":{},"confidence_threshold":0.7,"muted_topics":[]}'::jsonb, daily_spend_cap_usd numeric NOT NULL DEFAULT '0.50', secure_key_version smallint NOT NULL DEFAULT 1, updated_at timestamptz NOT NULL DEFAULT now());
